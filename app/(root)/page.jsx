        ...
        <div className="container grid grid-cols-1 gap-5 md:grid-cols-3 2xl:gap-0 md:px-10">
          ...
          <div className=" md:col-span-2 ">
            ...
            <p className="p-regular-14 md:p-regular-16 pt-4">
              ...
              The framework and libraries contribute diverse features, and the design and implementation phases showcase the projects effectiveness in providing accurate crop recommendations and irrigation guidance.
