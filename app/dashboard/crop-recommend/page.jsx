                ...
                <form onSubmit={handleSubmit} className="space-y-8 mx-auto md:max-w-md px-4">
                    ...
                    <section className="flex flex-1 gap-3 justify-evenly ">
                        <div className="space-y-2">
                            ...
                            <Input placeholder="temperature in °C" value={temperature} onChange={(e) => { setTemperature(e.target.value); setErrMssg('') }} type="number" />
                        </div>
                        <div className="space-y-2">
                            <label>Humidity</label>
                            <Input placeholder="Humidity in  g/m3" value={humidity} onChange={(e) => { setHumidity(e.target.value); setErrMssg('') }} type="number" />
                        </div>
                    </section>
                    <section className="flex flex-1 gap-3 justify-evenly ">
                        <div className="space-y-2">
